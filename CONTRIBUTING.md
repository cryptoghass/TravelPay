Contributing to Travel Pay Core
============================

The Travel Pay Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Travel Pay Core project, and is not to be
confused with overall Travel Pay Network Protocol consensus changes.

Whether a pull request is merged into Travel Pay Core rests with the project merge
...
Patches that change Travel Pay consensus rules are considerably more involved than
...
Where a patch set proposes to change the Travel Pay consensus, it must have been
...
The project leader is the release manager for each Travel Pay Core release.
