...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Travel Pay Core travelpay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  travelpay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded travelpay transaction") + "\n" +
                               "  travelpay-tx [options] -create [commands]   " + _("Create hex-encoded travelpay transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded travelpay transaction
