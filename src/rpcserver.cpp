...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Travel Pay server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Travel Pay server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Travel Pay features */
        {"travelpay", "masternode", &masternode, true, true, false},
        {"travelpay", "masternodelist", &masternodelist, true, true, false},
        {"travelpay", "mnbudget", &mnbudget, true, true, false},
        {"travelpay", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"travelpay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"travelpay", "mnsync", &mnsync, true, true, false},
        {"travelpay", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"travelpay", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use travelpayd, or the -server option to travelpay-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> travelpay-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:35161/\n";
}
