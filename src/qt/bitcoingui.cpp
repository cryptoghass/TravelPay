                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Travel Pay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Travel Pay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and travelpay: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Travel Pay Core"), this);
    aboutAction->setStatusTip(tr("Show information about Travel Pay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Travel Pay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Travel Pay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Travel Pay addresses"));
    ...
    openAction->setStatusTip(tr("Open a Travel Pay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Travel Pay Core help message to get a list with possible Travel Pay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Travel Pay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Travel Pay network", "", count));
}
...
{
    QString strTitle = tr("Travel Pay Core"); // default title
