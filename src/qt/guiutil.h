...
/** Utility functions used by the Travel Pay Qt UI.
 */
namespace GUIUtil
{
...
// Render Travel Pay addresses in monospace font
...
// Parse "travelpay:" URI into recipient object, return true on successful parsing
