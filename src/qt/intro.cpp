...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Travel Pay Core"),
     ...
     * override -datadir in the travelpay.conf file in the default data directory
     * (to be consistent with travelpayd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
