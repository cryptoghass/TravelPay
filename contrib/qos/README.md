...
This means one can have an always-on travelpayd instance running, and another local travelpayd/travelpay-qt instance which connects to this node and receives blocks from it.
