Travel Pay Core version 2.2.1 is now available from:

  <https://github.com/travelpay-project/travelpay/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/travelpay-project/travelpay/issues>

Compatibility
==============

Travel Pay Core is extensively tested on multiple operating systems using
...
Travel Pay Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Travel Pay was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/travelpay-project-translations/).
