...
In order to support loading of multiple wallets in travelpay-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is travelpay.cpp.
...
Changes to travelpay.cpp
----------------------
travelpay.cpp is the entry point into travelpay-qt, and as such, will require some minor modifications to provide hooks for
